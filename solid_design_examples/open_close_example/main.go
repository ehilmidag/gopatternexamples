...
//Open Closed amacı metodlarımızın genişletilebilir olması ama değiltirilmemesi aşağıdaki örnekte olduğu gibi
// bir filter mantığımız var ama farklı tip filtreler için aynı filtreyi tekrar tekrar kopyalamak yerine bir interface içinde
//halledebilmeliyiz
